...
//    @Resource
    ...
    public Object setex(String key,Object value){
        // 如果没有设置过期时间, 设置默认15分钟
        return setex(key,value,15*60);
    }

    public Object setex(String key,Object value,long expireTime){
        try{
            log.info("setex execute");
            set(key, value);
